...
POINT_CLOUD_REGISTER_POINT_STRUCT(
    OusterPointXYZIRT,
    (float, x, x) (float, y, y) (float, z, z) (float, intensity, intensity)
    (uint32_t, t, t) (uint16_t, reflectivity, reflectivity) (uint8_t, ring, ring) 
...
public:
  ImageProjection() : deskewFlag(0) {
    subImu =
        nh.subscribe<sensor_msgs::Imu>(imuTopic, 2000, &ImageProjection::imuHandler,
  ...
  void imuHandler(const sensor_msgs::Imu::ConstPtr &imuMsg) {
    ...
    // cout << "roll: " << imuRoll << ", pitch: " << imuPitch << ", yaw: " << imuYaw <<
    // endl << endl;
  }
    ...
    if (pointTime > imuTime[imuPointerFront] || imuPointerFront == 0) {
      ...
      *rotZCur = imuRotZ[imuPointerFront];
      ...
      double ratioBack = (imuTime[imuPointerFront] - pointTime) /
                         (imuTime[imuPointerFront] - imuTime[imuPointerBack]);
      *rotXCur =
          imuRotX[imuPointerFront] * ratioFront + imuRotX[imuPointerBack] * ratioBack;
      *rotYCur =
          imuRotY[imuPointerFront] * ratioFront + imuRotY[imuPointerBack] * ratioBack;
      *rotZCur =
          imuRotZ[imuPointerFront] * ratioFront + imuRotZ[imuPointerBack] * ratioBack;
    }
  }
  ...
  void findPosition(double relTime, float *posXCur, float *posYCur, float *posZCur) {
    ...
    *posZCur = 0;
    ...
    // If the sensor moves relatively slow, like walking speed, positional deskew seems
    // to have little benefits. Thus code below is commented.
